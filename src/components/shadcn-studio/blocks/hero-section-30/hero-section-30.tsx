        ...
        <div className='flex flex-col items-center gap-8 text-center'>
          <div className='flex flex-col items-center gap-4 text-center'>
            ...
            <MotionPreset
              ...
              delay={0.3}
              transition={{ duration: 0.5, ease: 'easeOut' }}
              className='z-10 text-2xl font-bold sm:text-3xl lg:text-5xl lg:font-bold'
            >
            ...
            <MotionPreset
              ...
              delay={0.5}
              transition={{ duration: 0.5, ease: 'easeOut' }}
              className='text-muted-foreground z-10 max-w-5xl text-xl sm:text-2xl lg:py-16 lg:text-3xl'
            >
