...
const HoverText = ({ text, duration }: { text: string; duration?: number; automatic?: boolean }) => {
  ...
  return (
    ...
    >
      ...
      <text
        ...
        strokeWidth='0.5'
        className='stroke-foreground/20 fill-transparent font-[helvetica] text-8xl font-bold'
