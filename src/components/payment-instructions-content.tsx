...
const paymentInstructionsCopy = {
  en: {
    ...
    memoReminder: 'Always include at least your group 4-letter code in the payment memo.',
  ...
  fr: {
    ...
    memoReminder:
      'Incluez toujours au moins le code à 4 lettres de votre groupe dans le mémo du paiement.',
    ...
    paymentSteps: [
      ...
      },
      {
        ...
        description:
          'Incluez toujours au moins le code à 4 lettres de votre groupe dans le mémo Zelle.'
      },
      {
        icon: Upload,
    ...
    reminders: [
      ...
      'Incluez toujours le code à 4 lettres de votre groupe lorsque vous effectuez un paiement.',
