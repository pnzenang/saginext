        ...
        <Table className='table-fixed text-sm'>
          <TableHeader>
            <TableRow className='bg-primary hover:bg-primary'>
              ...
              <TableHead className='text-primary-foreground w-64'>Association</TableHead>
              <TableHead className='text-primary-foreground w-32'>Payment</TableHead>
              <TableHead className='text-primary-foreground w-40'>Event</TableHead>
              <TableHead className='text-primary-foreground w-32 text-right'>Amount</TableHead>
              ...
              paginatedRows.map(row => (
                <TableRow key={row.id} className='odd:bg-muted/30 even:bg-background'>
                  ...
                  <TableCell className='py-4 align-top'>
                    ...
                    <p className='text-muted-foreground text-xs font-semibold'>{row.associationCode}</p>
                  </TableCell>
                  <TableCell className='py-4 align-top capitalize'>{row.paymentType}</TableCell>
                  <TableCell className='py-4 align-top'>
                    <Badge
                      variant='outline'
                      className={cn('rounded-md capitalize', getEventBadgeClassName(row.eventType))}
                    >
                      {formatLabel(row.eventType)}
                    </Badge>
                  </TableCell>
                  <TableCell className='py-4 text-right align-top font-extrabold tabular-nums'>
                    {currencyFormatter.format(row.amount)}
                  </TableCell>
