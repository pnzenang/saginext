  ...
  return (
    <section>
      <p className='text-muted-foreground mx-auto mb-5 max-w-4xl px-4 text-sm leading-6 sm:text-base'>
        ...
        an association has paid the required contribution, has an outstanding balance, or has an excess amount
        available. When an association sends more than the required amount, the extra money is recorded in front of that
