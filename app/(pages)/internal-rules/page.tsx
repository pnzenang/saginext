...
const InternalRulesAtGlance = async () => {
  const profile = await fetchProfile();
  return (
    <section className='relative py-52 '>
      <div className='container z-0'>
        <div className='text-center'>
          <h1 className='text-4xl font-semibold tracking-tight md:text-5xl lg:text-7xl'>
            Internal Rules At Glance
          </h1>
          <p className='mt-4 text-2xl text-muted-foreground md:text-3xl'>
            Everything you need to know about SAGI Internal Rules
          </p>
        </div>

        <div className='mx-auto mt-8 max-w-7xl space-y-12 md:mt-12 lg:mt-20'>
      ...
      <div className='absolute -inset-40 z-[-1] [mask-image:radial-gradient(circle_at_center,black_0%,black_20%,transparent_75%)]'></div>
    </section>
  );
};
export default InternalRulesAtGlance;
